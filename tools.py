...
def refresh_tables():
    network_df = pd.read_excel(os.path.join('tables', 'Network IDs.xlsx'), 'network_ids')
    default_avg_price_df = pd.read_excel(os.path.join('tables', 'Network IDs.xlsx'), 'default_avg_price')
